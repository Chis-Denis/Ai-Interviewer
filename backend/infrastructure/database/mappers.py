...
def interview_summary_model_to_entity(model: InterviewSummaryModel) -> InterviewSummary:
    return InterviewSummary(
        ...
        strengths=model.strengths if model.strengths else [],
        weaknesses=model.weaknesses if model.weaknesses else [],
        consistency_score=model.consistency_score,
        missing_information=model.missing_information if model.missing_information else [],
        overall_usefulness=model.overall_usefulness,
...
def interview_summary_entity_to_model(entity: InterviewSummary) -> InterviewSummaryModel:
    return InterviewSummaryModel(
        ...
        overall_usefulness=entity.overall_usefulness,
